...
public class Locations implements Map<Integer, Location> {
    ...
    public static void main(String[] args) throws IOException {
        ...
        try (RandomAccessFile rao = new RandomAccessFile("locations_rand.dat", "rwd")) {
            ...
            rao.writeInt(locations.size()); //how many locations there are
            int indexSize = locations.size() * 3 * Integer.BYTES; //the size of each index (how many locations there are * 3 (because we write locID , offset of the location and the length of the location
            // = 1 + 1 + 1 = 3) * Integer.BYTES ( = 4 ) )
            int locationStart = (int) (indexSize + rao.getFilePointer() + Integer.BYTES); //offsets...?
    ...
    static {
        ...
        try {
            ...
            System.out.println("IOE in static block " + e.getMessage());
        }
    }
