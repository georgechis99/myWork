...
public class Controller {
    ...
    private ObservableBooleanValue tableViewItemSelected;

    @FXML
    public void initialize(){

        listAlbumsButton.setDisable(true);
        artistTable.getSelectionModel().selectedItemProperty().addListener(((observableValue, oldSelection, newSelection) -> {
